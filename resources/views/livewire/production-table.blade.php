                    ...
                    <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button wire:click="downloadPdf('{{ $item->production_code }}')"
                                    wire:loading.attr="disabled"
                                    class="px-2 py-1  hover:cursor-pointer bg-gray-600 disabled:bg-gray-200 hover:bg-gray-700 text-white rounded-md transition">
                                    <div class="flex items-center gap-1">
                                        <span>
